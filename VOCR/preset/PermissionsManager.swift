...
final class PermissionsManager {
    ...
    private func screenRecordingStatus() -> PermissionStatus {
        // Check screen recording permission by attempting to get window list
        // If we can get detailed window info, we have permission
        ...
        // If we can't see any window names, permission is likely denied or not determined
        return .denied
    }
    ...
    func requestScreenRecording() {
        // Screen recording permission can only be granted in System Preferences
        // Trigger the permission prompt by attempting to capture
